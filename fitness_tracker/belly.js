document.addEventListener('DOMContentLoaded', () => {
  const thighExercises = [
      { name: "Plank", time: "3 sets, 12 reps", image: "planks.png" },
      { name: "Turkish get-Ups", time: "3 sets, 12 reps", image: "turkish-getups.png" },
      { name: "U-Up", time: "3 sets, 12 reps", image: "U-Up.png" }
  ];

  const thighExercisesContainer = document.getElementById('bellyExercises');

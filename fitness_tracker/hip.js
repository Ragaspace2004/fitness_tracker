document.addEventListener('DOMContentLoaded', () => {
  const thighExercises = [
      { name: "Contract and Release", time: "3 sets, 12 reps", image: "contract-release.jpg" },
      { name: "Runner", time: "3 sets, 12 reps", image: "runner.png" },
      { name: "Kicks", time: "3 sets, 12 reps", image: "kicks.png" }
  ];

  const thighExercisesContainer = document.getElementById('hipExercises');
